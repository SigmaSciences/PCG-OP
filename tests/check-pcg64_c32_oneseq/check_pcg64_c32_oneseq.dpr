program check_pcg64_c32_oneseq;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg64C32Oneseq;
begin
  Rng.Init(TUInt128.FromU64(42));
  RunPcgTest64('pcg64_c32_oneseq',
    TPcg64C32Oneseq.PeriodPow2, TPcg64C32Oneseq.StreamsPow2, SizeOf(TPcg64C32Oneseq), 5, False,
