program check_pcg32_c64_oneseq;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg32C64Oneseq;
begin
  Rng.Init(42);
  RunPcgTest32('pcg32_c64_oneseq',
    TPcg32C64Oneseq.PeriodPow2, TPcg32C64Oneseq.StreamsPow2, SizeOf(TPcg32C64Oneseq), 5, False,
