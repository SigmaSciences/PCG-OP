program check_pcg64_k32_oneseq;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg64K32Oneseq;
begin
  Rng.Init(TUInt128.FromU64(42));
  RunPcgTest64('pcg64_k32_oneseq',
    TPcg64K32Oneseq.PeriodPow2, TPcg64K32Oneseq.StreamsPow2, SizeOf(TPcg64K32Oneseq), 5, True,
