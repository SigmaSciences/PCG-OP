program check_pcg32_c1024_fast;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg32C1024Fast;
begin
  Rng.Init(42);
  RunPcgTest32('pcg32_c1024_fast',
    TPcg32C1024Fast.PeriodPow2, TPcg32C1024Fast.StreamsPow2, SizeOf(TPcg32C1024Fast), 5, False,
