...
var Rng: TPcg64K32Fast;
begin
  Rng.Init(TUInt128.FromU64(42));
  RunPcgTest64('pcg64_k32_fast',
    TPcg64K32Fast.PeriodPow2, TPcg64K32Fast.StreamsPow2, SizeOf(TPcg64K32Fast), 5, True,
