program check_pcg32_k1024_fast;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg32K1024Fast;
begin
  Rng.Init(42);
  RunPcgTest32('pcg32_k1024_fast',
    TPcg32K1024Fast.PeriodPow2, TPcg32K1024Fast.StreamsPow2, SizeOf(TPcg32K1024Fast), 5, True,
