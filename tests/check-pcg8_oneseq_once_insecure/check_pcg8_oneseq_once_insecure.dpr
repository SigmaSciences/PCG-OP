program check_pcg8_oneseq_once_insecure;
...
var
  Rng: TPcg8OneseqOnceInsecure;

begin
  Rng.Init(42);
  RunPcgTest8(
    'pcg8_oneseq_once_insecure',
    TPcg8OneseqOnceInsecure.PeriodPow2,
    TPcg8OneseqOnceInsecure.StreamsPow2,
    SizeOf(TPcg8OneseqOnceInsecure),
    5,
    True,
