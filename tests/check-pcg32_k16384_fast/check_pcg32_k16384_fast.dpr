program check_pcg32_k16384_fast;
{$APPTYPE CONSOLE}
{$Q-}{$R-}{$O+}
uses
  System.SysUtils,
...
var Rng: TPcg32K16384Fast;
begin
  Rng.Init(42);
  RunPcgTest32('pcg32_k16384_fast',
    TPcg32K16384Fast.PeriodPow2, TPcg32K16384Fast.StreamsPow2, SizeOf(TPcg32K16384Fast), 5, True,
